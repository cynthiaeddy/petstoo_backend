...
Pet.create(id: 7, name: 'bea', kind: 'dog',age: 15, owner_id: 5, color: 'brown, white, black', hair:'medium', image:'https://i.imgur.com/RstDVgB.png')
Pet.create(id: 8, name: 'mister', kind: 'cat',age: 2, owner_id: 5, color: 'orange', hair:'long', image:'https://i.imgur.com/LWeP84U.png')
Pet.create(id: 9, name: 'mufasa', kind: 'cat',age: 2, owner_id: 5, color: 'orange', hair:'long', image:'https://i.imgur.com/ArbYjGU.png')
Pet.create(id: 10, name: 'waffle', kind: 'dog',age: 5, owner_id: 5, color: 'black', hair:'short', image:'https://i.imgur.com/oICt9X0.png')
Pet.create(id: 11, name: 'wolfie', kind: 'cat',age: 7, owner_id: 5, color: 'black', hair:'long', image:'https://i.imgur.com/a0r45At.png')
Pet.create(id: 12, name: 'triumph', kind: 'dog',age: 8, owner_id: 5, color: 'orange', hair:'long', image:'https://i.imgur.com/fC0qi8o.png')
Pet.create(id: 13, name: 'plano', kind: 'dog',age: 5, owner_id: 5, color: 'white', hair:'medium', image:'https://i.imgur.com/U20WMWF.png')
